...
export async function fillDatabaseIfEmpty() {
  ...
  if (products.length === 0) {
    ...
    snowboard.picture = "https://images.unsplash.com/photo-1498146831523-fbe41acdc5ad";
    ...
    tent.picture = "https://images.unsplash.com/photo-1624923686627-514dd5e57bae";
    ...
    climbing.description_long = "Ceci est une description du matériel d'escalade à louer ! Il est super cool et vous permettra de grimper en toute sécurité !";
    ...
    backpack.picture = "https://images.unsplash.com/photo-1509762774605-f07235a08f1f";
