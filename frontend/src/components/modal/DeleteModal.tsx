...
const DeleteModal = ({ setShowModalDelete, articleName }: any) => {
         ...
         <div className="relative p-4 w-full max-w-md max-h-full">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
               ...
               <div className="p-4 md:p-5 text-center">
                  ...
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Confirmez-vous la suppression de tous les articles "{articleName}" ?</h3>
